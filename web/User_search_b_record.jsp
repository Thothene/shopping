...
<%
    ...
    List<B_record> b_recordList = (List<B_record>) httpSession.getAttribute("b_recordList");
    if (b_recordList == null) {
        String msg = "当前浏览记录为空！";
                ...
                <div class="Order_form_list">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="list_name_title4">商品库存</td>
                            <td class="list_name_title5">操作IP</td>
                        </tr>
                        </thead>
                        <%
                            for (B_record b_record : b_recordList){
                                Product product = productDao.select_by_pro_id(b_record.getBrec_pro_id());
                                String pro_image = product.getPro_image();
                                String pro_id = Integer.toString(product.getPro_id());
                        %>
                        <tbody>
                        <tr class="Order_info"><td colspan="6" class="Order_form_time">浏览时间：<%=b_record.getBrec_start_time()%> | 浏览时长：<%=b_record.getBrec_total_time()%>s <em></em></td></tr>
                        <tr class="Order_Details">
                            ...
                            <td width="12.5%"><%=product.getPro_number() - product.getPro_sold()%></td>
                            <td width="25%" class="split_line"><%=b_record.getBrec_ip()%></td>
                        </tr>
                        </tbody>
                        <%
                            }
