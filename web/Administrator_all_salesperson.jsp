...
<div class="Inside_pages clearfix">
    ...
    <div class="right_style">
        ...
        <div class="user_address_style">
            <div class="title_style"><em></em>查看销售员</div>
            <div class="Exp_record_style">
                <table cellpadding="0"  cellspacing="0"  width="100%" class="record_list">
                    <thead><tr class="label_name"><td width="15%">销售员id</td><td width="15%">销售员名称</td><td width="15%">销售员密码</td><td width="25%">销售员邮箱</td><td width="15%">销售员管理者编号</td><td width="15%">销售员是否激活</td></tr></thead>
                    <tbody>
                    <% for (Salesperson salesperson : sal_list){%>
                    <tr class="content">
                        <td><%=salesperson.getSal_id()%></td>
                        <td><%=salesperson.getSal_name()%></td>
                        <td><%=salesperson.getSal_password()%></td>
                        <td><%=salesperson.getSal_email()%></td>
                        <td><%=salesperson.getSal_a_id()%></td>
                        <td><%=salesperson.getSal_activation()%></td>
                    </tr>
                    <%}%>
                    </tbody>
                </table>
