    ...
    <div id="header_top">
        <div id="top">
            <div class="Inside_pages">
                <div class="Collection"><a href="Userlogin.jsp">登录</a></div>
                <div class="Collection"><a href="Salespersonlogin.jsp">销售员入口</a></div>
                <div class="Collection"><a href="Administratorlogin.jsp">管理员入口</a></div>
                <div class="Collection"><a href="Register.jsp">注册</a></div>
