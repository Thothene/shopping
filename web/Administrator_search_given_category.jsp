...
<%
    ...
    Category category = (Category) httpSession.getAttribute("given_category");

    // x代表横坐标轴 y代表该种类的销售额 z代表该种类的销售数量
    ...
    for (int i = 1; i <= 12; ++i){
        x_list.add("\""+i+"月\"");
        y_list.add(categoryDao.count_category_month_money(cat_id, String.valueOf(i)));
        z_list.add(categoryDao.count_category_month_number(cat_id, String.valueOf(i)));
    }
%>
