        ...
        <div class="content_style">
            ...
            <div class="Reportform_style">
                <div class="Reportform_table">
                    <div class="label_name">统计图表</div>
                    <ul class="inline date_inline">
                        &nbsp; 所有类别销售情况、各销售员销售业绩等图表~
                    </ul>
                </div>
                <div class="Reportform_table">
                    <div class="label_name">查看类别</div>
                    <ul class="inline date_inline">
                        &nbsp;查看所有类别的所有属性~
                    </ul>
                </div>
                <div class="Reportform_table">
                    <div class="label_name">查看销售员</div>
                    <ul class="inline date_inline">
                        &nbsp;查看所有销售员的所有属性~
                    </ul>
                </div>
                <div class="Reportform_table">
                    <div class="label_name">类别管理</div>
                    <ul class="inline date_inline">
                        &nbsp;管理类别的添加、删除、监控等~
                    </ul>
                </div>
                <div class="Reportform_table">
                    <div class="label_name">销售员管理</div>
                    <ul class="inline date_inline">
                        &nbsp;管理销售员的增加、删除、更改口令、更改所属类别等职能~
                    </ul>
                </div>
            </div>
        </div>
