...
<div class="Inside_pages clearfix">
    ...
    <div class="right_style">
        <!--内容详细-->
        <div class="title_style"><em></em>类别管理</div>
        <div class="content_style">
            <!--报表管理-->
            <div class="Reportform_style">
                <div class="Reportform_table">
                    <div class="label_name">监控特定类别的销售状况</div>
                    <ul class="inline date_inline">
                        &nbsp;
                        <form action="AdministratorServlet?action=search_given_category" method="post" style="display: inline">
                            类别ID：<input name="cat_id" type="number" >
                            类别名称：<input name="cat_name"  type="text" >
                            <input type="submit" value="提交"  class="Export_btn"/>
                        </form>
                    </ul>
                </div>
                <div class="Reportform_table">
                    <div class="label_name">增加类别</div>
                    <ul class="inline date_inline">
                        &nbsp;
                        <form action="AdministratorServlet?action=add_category" method="post" style="display: inline">
                            类别名称：<input type="text" name="cat_name">
                            类别所属销售员：<input type="number" name="cat_sal_id">
                            <input type="submit" value="提交"  class="Export_btn"/>
                        </form>
                    </ul>
                </div>
                <div class="Reportform_table">
                    <div class="label_name">删除类别</div>
                    <ul class="inline date_inline">
                        &nbsp;
                        <form action="AdministratorServlet?action=delete_category" method="post" style="display: inline">
                            类别名称：<input type="text" name="cat_name">
                            <input type="submit" value="提交"  class="Export_btn"/>
                        </form>
                    </ul>
