...
<%@ page import="com.wei.entity.B_record" %>
...
<%
    ...
    List<B_record> b_given_list = (List<B_record>) httpSession.getAttribute("b_given_list");
%>
<head>
    <div id="header_top">
        <div id="top">
...
<div class="Inside_pages clearfix">
    ...
    <div class="right_style">
        <!--内容详细-->
        <div class="title_style"><em></em>特定商品的浏览记录</div>
                ...
                <div class="Order_form_style">
                    <div class="Order_form_list">
                        <table>
                            <thead>
                            <tr>
                                <td class="list_name_title1">浏览用户ID</td>
                                <td class="list_name_title1">浏览时间</td>
                                <td class="list_name_title1">浏览时长(s)</td>
                                <td class="list_name_title1">浏览IP</td>
                            </tr>
                            </thead>
                            <%
                                for (B_record b_record : b_given_list){
                            %>
                            <tbody>
                            <tr class="Order_Details">
                                <td width="25%"><%=b_record.getBrec_user_id()%></td>
                                <td width="25%"><%=b_record.getBrec_start_time()%></td>
                                <td width="25%"><%=b_record.getBrec_total_time()%></td>
                                <td width="25%"><%=b_record.getBrec_ip()%></td>
                            </tr>
                            </tbody>
                            <%
                                }
