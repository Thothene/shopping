...
<%
    ...
    List<P_record> p_given_list = (List<P_record>) httpSession.getAttribute("p_given_list");
%>
<head>
    <div id="header_top">
        <div id="top">
...
<div class="Inside_pages clearfix">
    ...
    <div class="right_style">
        <!--内容详细-->
        <div class="title_style"><em></em>特定商品购买记录</div>
                ...
                <div class="Order_form_style">
                    <div class="Order_form_list">
                        <table>
                            <thead>
                            <tr>
                                <td class="list_name_title20">购买用户ID</td>
                                <td class="list_name_title20">购买时间</td>
                                <td class="list_name_title20">购买数量(个)</td>
                                <td class="list_name_title20">购买总金额</td>
                                <td class="list_name_title20">购买IP</td>
                            </tr>
                            </thead>
                            <%
                                for (P_record p_record : p_given_list){
                            %>
                            <tbody>
                            <tr class="Order_Details">
                                <td width="20%"><%=p_record.getPrec_user_id()%></td>
                                <td width="20%"><%=p_record.getPrec_time()%></td>
                                <td width="20%"><%=p_record.getPrec_number()%></td>
                                <td width="20%"><%=p_record.getPrec_total_money()%></td>
                                <td width="20%"><%=p_record.getPrec_ip()%></td>
                            </tr>
                            </tbody>
                            <%
                                }
